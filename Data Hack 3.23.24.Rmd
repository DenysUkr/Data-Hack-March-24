...
ggplot(data=allRatedSchools, aes(x=X..Economically.Disadvantaged, t=Overall.Score) ) + geom_dotplot(col="navy", fill="red4") + labs( title = "Histogram of the School Proportion of Economicly Disadvantaged Students", x="Proportion of Economicly Disdvantage Students")
